defmodule TbgNodesWeb.EnsureRolePlug do
  @moduledoc """
  This plug ensures that a user has a particular role.

  ## Example

      plug TbgNodesWeb.EnsureRolePlug, [:user, :admin]

      plug TbgNodesWeb.EnsureRolePlug, :admin

      plug TbgNodesWeb.EnsureRolePlug, ~w(user admin)a
  """
  ...
  defp maybe_halt(_any, conn) do
    ...
    |> Controller.redirect(to: Routes.redirect_path(conn, :handle_redirect))
    |> halt()
  end
end
