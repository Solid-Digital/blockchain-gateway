...
// WithOrgName adds the orgName to the delete pipeline params
func (o *DeletePipelineParams) WithOrgName(orgName string) *DeletePipelineParams {
	o.SetOrgName(orgName)
	return o
}

// SetOrgName adds the orgName to the delete pipeline params
func (o *DeletePipelineParams) SetOrgName(orgName string) {
	o.OrgName = orgName
}

// WithPipelineName adds the pipelineName to the delete pipeline params
func (o *DeletePipelineParams) WithPipelineName(pipelineName string) *DeletePipelineParams {
	o.SetPipelineName(pipelineName)
	return o
}

// SetPipelineName adds the pipelineName to the delete pipeline params
func (o *DeletePipelineParams) SetPipelineName(pipelineName string) {
