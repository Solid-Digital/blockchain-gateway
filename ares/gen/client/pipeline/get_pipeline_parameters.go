...
// WithOrgName adds the orgName to the get pipeline params
func (o *GetPipelineParams) WithOrgName(orgName string) *GetPipelineParams {
	o.SetOrgName(orgName)
	return o
}

// SetOrgName adds the orgName to the get pipeline params
func (o *GetPipelineParams) SetOrgName(orgName string) {
	o.OrgName = orgName
}

// WithPipelineName adds the pipelineName to the get pipeline params
func (o *GetPipelineParams) WithPipelineName(pipelineName string) *GetPipelineParams {
	o.SetPipelineName(pipelineName)
	return o
}

// SetPipelineName adds the pipelineName to the get pipeline params
func (o *GetPipelineParams) SetPipelineName(pipelineName string) {
