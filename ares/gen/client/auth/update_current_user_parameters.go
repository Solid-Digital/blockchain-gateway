...
func (o *UpdateCurrentUserParams) WithBody(body *dto.UpdateCurrentUserRequest) *UpdateCurrentUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update current user params
func (o *UpdateCurrentUserParams) SetBody(body *dto.UpdateCurrentUserRequest) {
	o.Body = body
}
