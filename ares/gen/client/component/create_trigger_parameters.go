...
func (o *CreateTriggerParams) WithBody(body *dto.CreateComponentRequest) *CreateTriggerParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create trigger params
func (o *CreateTriggerParams) SetBody(body *dto.CreateComponentRequest) {
	o.Body = body
}

// WithOrgName adds the orgName to the create trigger params
func (o *CreateTriggerParams) WithOrgName(orgName string) *CreateTriggerParams {
	o.SetOrgName(orgName)
	return o
}

// SetOrgName adds the orgName to the create trigger params
func (o *CreateTriggerParams) SetOrgName(orgName string) {
	o.OrgName = orgName
}
