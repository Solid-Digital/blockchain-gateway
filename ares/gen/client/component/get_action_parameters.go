...
// WithName adds the name to the get action params
func (o *GetActionParams) WithName(name string) *GetActionParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the get action params
func (o *GetActionParams) SetName(name string) {
	o.Name = name
}

// WithOrgName adds the orgName to the get action params
func (o *GetActionParams) WithOrgName(orgName string) *GetActionParams {
	o.SetOrgName(orgName)
	return o
}

// SetOrgName adds the orgName to the get action params
func (o *GetActionParams) SetOrgName(orgName string) {
	o.OrgName = orgName
}
