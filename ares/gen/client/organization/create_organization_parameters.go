...
func (o *CreateOrganizationParams) WithBody(body *dto.CreateOrganizationRequest) *CreateOrganizationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create organization params
func (o *CreateOrganizationParams) SetBody(body *dto.CreateOrganizationRequest) {
	o.Body = body
}
