...
func (o *UpdateOrganizationParams) WithBody(body *dto.UpdateOrganizationRequest) *UpdateOrganizationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update organization params
func (o *UpdateOrganizationParams) SetBody(body *dto.UpdateOrganizationRequest) {
	o.Body = body
}

// WithOrgName adds the orgName to the update organization params
func (o *UpdateOrganizationParams) WithOrgName(orgName string) *UpdateOrganizationParams {
	o.SetOrgName(orgName)
	return o
}

// SetOrgName adds the orgName to the update organization params
func (o *UpdateOrganizationParams) SetOrgName(orgName string) {
	o.OrgName = orgName
}
