...
type GetAllActionsHandlerFunc func(GetAllActionsParams, *dto.User) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAllActionsHandlerFunc) Handle(params GetAllActionsParams, principal *dto.User) middleware.Responder {
	return fn(params, principal)
}

// GetAllActionsHandler interface for that can handle valid get all actions params
type GetAllActionsHandler interface {
	Handle(GetAllActionsParams, *dto.User) middleware.Responder
}
...
/*GetAllActions swagger:route GET /orgs/{orgName}/actions component getAllActions

Get all actions in this organization
