...
// GetAllEnvironmentVariablesParams contains all the bound params for the get all environment variables operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetAllEnvironmentVariables
...
//
// To ensure default values, the struct must have been initialized with NewGetAllEnvironmentVariablesParams() beforehand.
func (o *GetAllEnvironmentVariablesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAllEnvironmentVariablesParams) bindEnvName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAllEnvironmentVariablesParams) bindOrgName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAllEnvironmentVariablesParams) bindPipelineName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
