...
// DeletePipelineParams contains all the bound params for the delete pipeline operation
// typically these are obtained from a http.Request
//
// swagger:parameters DeletePipeline
...
//
// To ensure default values, the struct must have been initialized with NewDeletePipelineParams() beforehand.
func (o *DeletePipelineParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeletePipelineParams) bindOrgName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeletePipelineParams) bindPipelineName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
