...
// DeployConfigurationParams contains all the bound params for the deploy configuration operation
// typically these are obtained from a http.Request
//
// swagger:parameters DeployConfiguration
...
//
// To ensure default values, the struct must have been initialized with NewDeployConfigurationParams() beforehand.
func (o *DeployConfigurationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body dto.DeployConfigurationRequest
...
func (o *DeployConfigurationParams) bindEnvName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeployConfigurationParams) bindOrgName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeployConfigurationParams) bindPipelineName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
