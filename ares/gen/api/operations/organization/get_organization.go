...
type GetOrganizationHandlerFunc func(GetOrganizationParams, *dto.User) middleware.Responder

// Handle executing the request and returning a response
func (fn GetOrganizationHandlerFunc) Handle(params GetOrganizationParams, principal *dto.User) middleware.Responder {
...
type GetOrganizationHandler interface {
	Handle(GetOrganizationParams, *dto.User) middleware.Responder
}
...
/*GetOrganization swagger:route GET /orgs/{orgName} organization getOrganization
