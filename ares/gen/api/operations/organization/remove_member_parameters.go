...
// RemoveMemberParams contains all the bound params for the remove member operation
// typically these are obtained from a http.Request
//
// swagger:parameters RemoveMember
...
//
// To ensure default values, the struct must have been initialized with NewRemoveMemberParams() beforehand.
func (o *RemoveMemberParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RemoveMemberParams) bindEmail(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *RemoveMemberParams) validateEmail(formats strfmt.Registry) error {
...
func (o *RemoveMemberParams) bindOrgName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
