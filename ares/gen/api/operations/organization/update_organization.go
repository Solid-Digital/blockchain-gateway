...
type UpdateOrganizationHandlerFunc func(UpdateOrganizationParams, *dto.User) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdateOrganizationHandlerFunc) Handle(params UpdateOrganizationParams, principal *dto.User) middleware.Responder {
...
type UpdateOrganizationHandler interface {
	Handle(UpdateOrganizationParams, *dto.User) middleware.Responder
}
...
/*UpdateOrganization swagger:route PUT /orgs/{orgName} organization updateOrganization
